...
Internal package; depended on as `@tinycode-ai/http-recorder` from another
workspace package.

```ts
import { HttpRecorder } from "@tinycode-ai/http-recorder"
```
...
```ts
import { HttpRecorder, Redactor } from "@tinycode-ai/http-recorder"
