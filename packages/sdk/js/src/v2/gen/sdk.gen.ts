...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new TinycodeClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the tinycode system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the tinycode system.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global tinycode configuration settings and preferences.
   */
   ...
   *
   * Update global tinycode configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the tinycode server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the tinycode system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all tinycode instances, releasing all resources.
   */
   ...
   * Upgrade tinycode
   *
   * Upgrade tinycode to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current tinycode configuration settings and preferences.
   */
   ...
   *
   * Update tinycode configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local tinycode state.
   */
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current tinycode instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the tinycode system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with tinycode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that tinycode is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by tinycode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all tinycode sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new tinycode session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific tinycode session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class TinycodeClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<TinycodeClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    TinycodeClient.__registry.set(this, args?.key)
  }
