...
class Database extends Context.Service<Database, DatabaseShape>()("@tinycode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@tinycode/example/UserStore") {
