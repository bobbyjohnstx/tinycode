...
const releaseId = process.env.TINYCODE_RELEASE
if (!releaseId) throw new Error("TINYCODE_RELEASE is required")

const version = process.env.TINYCODE_VERSION
if (!version) throw new Error("TINYCODE_VERSION is required")
...
const macxTarGz = "tinycode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "tinycode-desktop-mac-arm64.app.tar.gz"
