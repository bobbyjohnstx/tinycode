...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@tinycode/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@tinycode/ToolRegistry") {}
