...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@tinycode/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.TINYCODE_FAKE_VCS)
