...
export class Service extends Context.Service<Service, Interface>()("@tinycode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __TINYCODE_PHOTON_WASM_PATH?: string }).__TINYCODE_PHOTON_WASM_PATH =
