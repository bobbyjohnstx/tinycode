import type { JsonSchema, LLMRequest, ProviderMetadata } from "@tinycode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@tinycode/llm"
import { AmazonBedrock, Anthropic, Azure, Google, OpenAI, OpenAICompatible, OpenRouter } from "@tinycode/llm/providers"
...
export const request = (input: RequestInput) => {
  ...
  // @tinycode/llm request objects from tinycode's session/AI SDK-shaped data.
  return LLM.request({
