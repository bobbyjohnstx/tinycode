...
import type { Event, GlobalEvent, OpencodeClient } from "@tinycode/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@tinycode/RunStreamTransport") {}
