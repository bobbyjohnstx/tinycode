...
//
// the saved variant persists across sessions in ~/.local/state/tinycode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@tinycode/RunVariant") {}
