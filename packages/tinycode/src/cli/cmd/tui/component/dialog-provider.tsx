...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@tinycode/sdk/v2"
    ...
    const value = await DialogPrompt.show(dialog, "Other", {
      ...
      description: () => (
        <text fg={theme.textMuted}>
          This only stores a credential. Configure the provider in tinycode.json to use it.
        </text>
      ),
    })
