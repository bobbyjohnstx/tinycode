...
import { sanitizedProcessEnv } from "@/core/util/tinycode-process"
...
export class Service extends Context.Service<Service, Interface>()("@tinycode/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".tinycode")) continue
