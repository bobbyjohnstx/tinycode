...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders TINYCODE_CALLER", () => {
    process.env["TINYCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode TINYCODE_CALLER", () => {
    process.env["TINYCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown TINYCODE_CALLER", () => {
    process.env["TINYCODE_CALLER"] = "unknown"
