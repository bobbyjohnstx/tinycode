...
Practical reference for the current tool-migration state in `packages/tinycode`.
...
Tool tests should use the existing Effect helpers in `packages/tinycode/test/lib/effect.ts`:
