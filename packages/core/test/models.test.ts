...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.TINYCODE_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.TINYCODE_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.TINYCODE_MODELS_PATH = undefined
  Flag.TINYCODE_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.TINYCODE_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.TINYCODE_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
