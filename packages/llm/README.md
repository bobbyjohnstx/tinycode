...
Schema-first LLM core for tinycode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@tinycode/llm"
import { OpenAI } from "@tinycode/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@tinycode/llm/providers"
