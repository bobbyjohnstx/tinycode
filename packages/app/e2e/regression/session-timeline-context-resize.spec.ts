...
const directory = "C:/tinycode/ContextResizeRegression"
...
const model = { providerID: "tinycode", modelID: "claude-opus-4-6", variant: "max" }
...
function provider() {
  return {
    ...
    connected: ["tinycode"],
    default: { providerID: "tinycode", modelID: "claude-opus-4-6" },
  }
}
