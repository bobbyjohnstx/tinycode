...
import type { Agent } from "@tinycode/sdk/v2/client"
...
describe("directoryKey", () => {
  test("normalizes slashes", () => {
    expect(String(directoryKey("C:\\Repos\\sst\\tinycode"))).toBe("C:/Repos/sst/tinycode")
    expect(String(directoryKey("C:/Repos/sst/tinycode"))).toBe("C:/Repos/sst/tinycode")
  })
