export const dict = {
  ...
  "dialog.provider.tinycode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.tinycode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.tinycodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo tinycode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no tinycode.",
  ...
  "provider.connect.tinycodeZen.line1":
    "tinycode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.tinycodeZen.visit.prefix": "Visite ",
  "provider.connect.tinycodeZen.visit.link": "tinycode.dev/zen",
  "provider.connect.tinycodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no tinycode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no tinycode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em tinycode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor tinycode este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do tinycode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do tinycode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (tinycode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: tinycode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "tinycode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor tinycode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do tinycode",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o tinycode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o tinycode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o tinycode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o tinycode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do tinycode.",
