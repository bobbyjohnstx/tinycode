export const dict = {
  ...
  "dialog.provider.tinycode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.tinycode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.tinycodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez tinycode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w tinycode.",
  ...
  "provider.connect.tinycodeZen.line1":
    "tinycode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.tinycodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.tinycodeZen.visit.link": "tinycode.dev/zen",
  "provider.connect.tinycodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w tinycode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w tinycode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w tinycode.json",
  ...
  "dialog.server.description": "Przełącz serwer tinycode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja tinycode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu tinycode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (tinycode.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, tinycode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "tinycode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the tinycode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla tinycode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd tinycode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy tinycode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw tinycode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania tinycode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji tinycode.",
