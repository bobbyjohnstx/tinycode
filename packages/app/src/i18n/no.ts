...
export const dict = {
  ...
  "dialog.provider.tinycode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.tinycode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.tinycodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av tinycode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i tinycode.",
  ...
  "provider.connect.tinycodeZen.line1":
    "tinycode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.tinycodeZen.visit.prefix": "Besøk ",
  "provider.connect.tinycodeZen.visit.link": "tinycode.dev/zen",
  "provider.connect.tinycodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i tinycode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i tinycode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i tinycode.json",
  ...
  "dialog.server.description": "Bytt hvilken tinycode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av tinycode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til tinycode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (tinycode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at tinycode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "tinycode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør tinycode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for tinycode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan tinycode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om tinycode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan tinycode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når tinycode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av tinycode.",
