export const dict = {
  ...
  "dialog.provider.tinycode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.tinycode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.tinycodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje tinycode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u tinycode-u.",
  ...
  "provider.connect.tinycodeZen.line1":
    "tinycode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.tinycodeZen.visit.prefix": "Posjeti ",
  "provider.connect.tinycodeZen.visit.link": "tinycode.dev/zen",
  "provider.connect.tinycodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u tinycode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u tinycode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u tinycode.json",
  ...
  "dialog.server.description": "Promijeni na koji se tinycode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija tinycode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku tinycode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (tinycode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: tinycode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "tinycode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni tinycode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u tinycode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako tinycode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li tinycode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu tinycode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se tinycode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju tinycode-a.",
