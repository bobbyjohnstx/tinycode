...
import { ResizeHandle } from "@tinycode/ui/resize-handle"
...
import { Session, type Message } from "@tinycode/sdk/v2/client"
...
import { useTheme, type ColorScheme } from "@tinycode/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://tinycode.dev/desktop-feedback")}
      renderPanel={() =>
