...
import { Tooltip, TooltipKeybind } from "@tinycode/ui/tooltip"
import { useTheme } from "@tinycode/ui/theme/context"
...
import { iife } from "tinycode/core/util/iife"
import { base64Encode } from "tinycode/core/util/encode"
import { Avatar as AvatarV2 } from "@tinycode/ui/v2/components/avatar-v2.jsx"
        ...
        <Match when>
          ...
          >
            ...
            <div
              ...
              onMouseDown={drag}
            >
              <div id="tinycode-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function TitlebarV2Right(props: { state: TitlebarV2RightState }) {
  return (
    <div class="flex shrink-0 items-center justify-end gap-0">
      ...
      <div id="tinycode-titlebar-right" class="flex shrink-0 items-center justify-end gap-0" />
    </div>
  )
}
