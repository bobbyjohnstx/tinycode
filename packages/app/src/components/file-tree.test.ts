...
beforeAll(async () => {
  ...
  mock.module("@tinycode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@tinycode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@tinycode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@tinycode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
